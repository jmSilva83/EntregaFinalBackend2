...
//           { code: data.code },
//           { $inc: { stock: data.stock } }, // Incrementa el stock
//           { new: true }
//         );
//         if (!updatedProduct) {
...
export default class ProductManager {
  getProducts(queryObject, options) {
    return productModel.paginate(queryObject, options);
  }

  countDocuments(queryObject) {
    return productModel.countDocuments(queryObject);
  }
  ...
  updateProductStockByCode(code, stock) {
